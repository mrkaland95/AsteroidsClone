...
public class Settings {
    ...
    static public final float SHIP_VELOCITY_LIMIT = 100f;
    static public final float ASTEROID_VELOCITY_LIMIT = 65f;
    static public final float DEGREES_ROTATED_PER_TICK = 3f;
    static public final float SHIP_ACCELERATION_PER_SECOND = 100f;

    static public final float MIN_SPAWN_DISTANCE = 100f;
